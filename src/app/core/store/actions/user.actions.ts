...
import { IUploadAvatarRes, IChangePasswordReq, IResendOnboardingInviteReq, IValidateOnboardingEmailTokenReq, IValidateOnboardingEmailTokenRes, IValidatePasswordRes, IValidatePasswordReq } from '@app/core/services';
...
export const validatePasswordSuccessAction = createAction(ACTION_TYPES.VALIDATE_PASSWORD_SUCCESS, props<ResultState<IValidatePasswordRes>>());
export const validatePasswordFailureAction = createAction(ACTION_TYPES.VALIDATE_PASSWORD_FAILURE, props<ResultState<null>>());
