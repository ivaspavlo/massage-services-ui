...
import { IUploadAvatarRes, IChangePasswordRes, IValidateResetTokenRes, ILoginRes, ICheckIfEmailAddressInUseRes, IValidatePasswordRes } from '@app/core/services';
...
const userReducer = createReducer<IUserState, Action>(
  ...
  on(UserActions.changePasswordSuccessAction, (state: IUserState, { result, callState }: ResultState<IChangePasswordRes>) => ({ ...state, ...result, update_password_data: { password_verified: true, password_changed: true }, callState })),
  ...
  on(UserActions.updateProfileSuccessAction, (state: IUserState, { result, callState }: ResultState<IUserProfile>) => ({ ...state, user_profile: result, callState })),
  ...
  on(UserActions.validatePasswordSuccessAction, (state: IUserState, { result, callState }: ResultState<IValidatePasswordRes>) => ({ ...state, update_password_data: { password_verified: result.password_valid, password_changed: false }, callState })),
  on(UserActions.validatePasswordFailureAction, (state: IUserState, { callState }: ResultState<null>) => ({ ...state, callState })),
