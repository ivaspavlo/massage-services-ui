...
import { map, mergeMap, catchError, switchMap, tap, filter } from 'rxjs/operators';
...
import { AuthService, ToasterService, UserService, ILoginReq, ILoginRes, IUserRegisterReq, ICheckIfEmailAddressInUseRes, IRemindPasswordReq, IPasswordResetReq, ICheckIfEmailAddressInUseReq, IValidateResetTokenReq, IValidateResetTokenRes } from '@app/core/services';
...
export class AuthEffects {
  ...
  private openInfoModal(data: any): Observable<any> {
    return of(true);
