...
import { IValidateOnboardingEmailTokenReq, IValidateOnboardingEmailTokenRes, IUserProfile, IUploadAvatarReq, IUploadAvatarRes, IChangePasswordReq, IResendOnboardingInviteReq, IResendOnboardingInviteRes } from '@app/interfaces';
...
export class UserEffects {
  ...
  validatePassword$ = createEffect((): any => this.actions$.pipe(
    ofType(UserActions.ACTION_TYPES.VALIDATE_PASSWORD),
    switchMap((req: IValidatePasswordReq) => this.userService.checkPassword(req)
      .pipe(
        effectsResponseHandler,
